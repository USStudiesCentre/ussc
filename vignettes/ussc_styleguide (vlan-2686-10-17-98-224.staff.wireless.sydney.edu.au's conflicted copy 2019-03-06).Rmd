...
table <- tribble(
  ...
  "Title", "Univers Ltd", "Bold", 14, "#444444", "The title should be pithy and SEO-friendly. Titles should explain the content within the graph, not solely describe the axis labels.",
...
** Note: if you are comparing the United States and Australia, please use <span style = "background-color:#ED1B35;color:white;";>USSC red for US data</span> and <span style = "background-color:#009DE3 ;color:white;";>USSC light blue for Australia data</span>. Similarly, <span style = "background-color:#ED1B35;color:white;";>Republican data is USSC red</span> and <span style = "background-color:#1C396E;color:white;";>Democrat data is USSC dark blue</span>. Reverse the party colour for Australian political parties (i.e. <span style = "background-color:#ED1B35;color:white;";>ALP</span>, <span style = "background-color:#1C396E;color:white;";>Coaltion</span>). **
