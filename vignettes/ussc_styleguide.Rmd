...
* Remove axis
* Remove colour
* Simplify axis labels, remove if redundant. If you can not simplify x-axis labels, flip the chart so the reader can read the x-axis label (now the y-axis label) easily.
