...
table <- tribble(
  ...
  "X and Y axis labels", "Univers Light", "Regular", 12, "#444444", "Labels should always be horizontal. Include units here. To save space, consider adding a unit for the first observation (at the top right hand corner for the Y axis or the bottom left hand corner for the X axis).",
  "Axis ticks", NA, NA, NA, "#D3D3D3", NA,
  "Legend title", "Univers Ltd", "Bold", 11, "#444444", NA,
  "Key labels", "Univers Light", "Regular", 12, "#444444", "Should always be horizontal. If the legend is either on top or at the bottom of the graph, set the key labels so that they are below/above the key and not beside it.",
