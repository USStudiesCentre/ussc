...
> A table is nearly always better than a dumb pie chart; the only worse design than a pie chart is several of them, for then the viewer is asked to compare quantities located in spatial disarray both within and between pies. (Tufte, p178, *The Visual Display of Quantitative Information*).

<!-- ![Anthony Green on the futility of pie charts...](green_pie.png) -->
