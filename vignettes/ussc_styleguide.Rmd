...
* We have plotted the in-party approval rating for 12 US presidents in their first year in office. It is impossible to see the data clearly - this is the perfect example of a *spaghetti chart* (i.e. it looks like a pile of spaghetti). 
...
* Scatter plots graph the relationship between two continuous variables.
