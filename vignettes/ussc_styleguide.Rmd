...
table <- tribble(
  ...
  "X and Y axis labels", "Univers Light", "Regular", 12, "#444444", "Labels should always be horizontal. Include units and punctuation (i.e. break large numbers with commas). To save space, consider adding a unit only for the first observation (at the top right hand corner for the Y axis or the bottom left hand corner for the X axis).",
