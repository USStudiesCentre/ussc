...
* We have timeseries data for 12 Presidents in one chart. It is impossible to see the data clearly - this is the perfect example of a *spaghetti chart*. There are ways to fix this problem. Maybe we're only interested in President Trump. We can selectively highlight his approval rating in red.
