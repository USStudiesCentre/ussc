...
* What if, instead of emphasising President Trump, we want to compare all presidents from 1956 onwards? We can easily do this by splitting data into several small charts.
