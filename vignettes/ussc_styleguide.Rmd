...
The following document is a guide for visualising data effectively in a style consistent with the Centre's colours and fonts.  It covers common errors and explains what should be done instead. The guidelines presented in this document are consistent with data visualisation best practices and help provide a uniform look for the Centre's graphs.
