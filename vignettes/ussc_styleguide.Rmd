...
Sometimes, we have too much information on one plot. See e.g.:
...
ggplot(pid_data) + 
  ...
  labs(title = "In-party approval rating for American Presidents from 1956-2018",
       ...
       x = "Days into Presidency", 
       y = NULL) + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 2))
```

* In the plot above, we plotted time series data for 12 US presidents, ranging from Eisenhower to Trump. It is impossible to see the data clearly - this is the perfect example of a *spaghetti chart*. There are ways to fix this problem. Maybe we're only interested in President Trump. We can selectively highlight Trump's in-party approval rating.
...
* What if, instead of looking at one President, we want to compare all Presidents from 1956 onwards? We can do easily this by splitting data into several small charts.
