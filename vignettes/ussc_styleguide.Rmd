...
* What if, instead of emphasising one President, we want to compare all Presidents from 1956 onwards? We can do easily this by splitting data into several small charts.
