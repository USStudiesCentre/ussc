...
How we present data *matters*. Our primary goal at USSC is to present our information in an aesthetic, scientifically-rigorous manner. We aim to convey our message as clearly and as cleanly as we can. As Edward Tufte (one of the pioneers of data visualisation) wrote, "Confusion and clutter are failures of design, not attributes of information" [@tufte1990envisioning, p. 53]. It is important to remember that visualising data is not for our benefit as researchers, but rather for those who consume our work.

With that being said, there are a few key points to keep in mind if you're working with data. Given that we are a think tank working on empirical research questions, our visualisation work should match the standard of "good" data visualization and ideally go far beyond that relatively low benchmark. This means following the best practices in data visualisation and, more broadly, statistics. There are several guides for effectively visualising data. Edward Tufte's books, for example, are extremely helpful. 
