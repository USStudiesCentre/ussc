...
two <- ggplot(data=ChickWeight, 
       aes(x=Time, y=weight, color=Diet, group=Chick)) +
  geom_line() + 
  labs(title = "b) Small multiples line graph") + 
  scale_colour_ussc("light") + 
  theme_ussc() + 
  theme(legend.position = 'none') + 
...
ggplot(pid_data) + 
  ...
  theme_ussc() + 
  labs(title = "In-party approval rating for the American President",
...
* This is *insane*. We can organise our data better than this!
