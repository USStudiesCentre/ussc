...
`theme_ussc_univers()` is a wrapper for `theme_bw()` that uses the Univers font. We have set the `scale_colour_ussc()` to the blue palette which ranges from the official USSC dark blue colour to the light blue USSC colour.
