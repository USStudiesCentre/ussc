...
```{r ussc theme and main colour scale, fig.align='center', fig.showtext=TRUE}
ggplot(iris, aes(Sepal.Width, Sepal.Length, colour = Species)) + 
  geom_point(size = 4, alpha=0.4) +  
  theme_ussc() + 
  labs(title="Halis GR Bold", x="Halis GR: Sepal Width", y="Halis GR Font: Sepal Length", caption = "The data is from the Iris R package and is an example.") + 
...
```{r univers ussc theme and blue colour scale, fig.align='center', dev.args=list(bg='#2a2a2b'), fig.showtext=TRUE}
ggplot(iris, aes(Sepal.Width, Sepal.Length, colour = Species)) + 
  geom_point(size = 4, alpha=0.4) +  
  theme_ussc_dark() + 
  labs(title="Halis GR Bold", 
       x="Halis GR: Sepal Width", 
       y="Halis GR: Sepal Length", 
...
```{r facet ussc theme and main colour scale, fig.align='center', fig.showtext=TRUE}
...
# GAM 
```{r GAM, fig.align='center', fig.showtext=TRUE}
