...
All `ussc` themes have a transparent background. You can set the background colour of a graph by using developer arguments. To do this, append a CSS style sheet (which affects the entire HTML document) or write ```{r dev.args = list(bg = 'color')}``` for a specific graph. A few examples are as follows:
