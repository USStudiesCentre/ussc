...
theme_ussc <- function() {
  theme_bw(base_family = "univers") +
    theme(
      ...
      axis.text.x = element_text(size = 12, "univers", face = "bold.italic"),
      axis.text.y = element_text(size = 12, "univers", face = "bold.italic"),
      legend.text = element_text(size = 12, "univers", face = "bold.italic"),
