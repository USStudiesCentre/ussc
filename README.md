...
If you want to write a report with USSC fonts, download ussc_fonts.css. It can be found in the CSS folder of this R package. Add the file to the yaml in your R markdown file. Note: the fonts in the CSS file must be the same as those in your Font Book. 
```
---
title: Test
author: Zoe Meers
